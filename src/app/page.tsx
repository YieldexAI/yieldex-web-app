import { ArrowRight, Shield, LineChart, Coins, ArrowLeftRight, TrendingUp, BarChart3, PieChart, Percent, HelpCircle } from 'lucide-react';
    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white pixel-font">
      ...
      <header className="container mx-auto px-4 py-6 relative z-10">
        <div className="flex items-center justify-between">
          ...
          <button className="pixel-button bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4">
      ...
      <div className="hero-section container mx-auto px-4 py-16 relative">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
          ...
          <p className="text-xl text-gray-300 mb-8 pixel-text-sm">
            Automatically optimize your stablecoin holdings across DeFi protocols
          </p>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 pixel-text">YOUR YIELD DASHBOARD</h2>
          <p className="text-gray-300 pixel-text-sm">Track and optimize your yields in real-time</p>
        </div>
            ...
            <div className="lg:col-span-2">
              <div className="pixel-card p-6 bg-gray-800 border-2 border-green-400 h-full">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-bold pixel-text">PORTFOLIO OVERVIEW</h3>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="pixel-card p-6 bg-gray-800 border-2 border-green-400">
            ...
            <h3 className="text-xl font-bold mb-2 pixel-text">FORTIFIED SECURITY</h3>
            <p className="text-gray-300 pixel-text-sm">Battle-tested smart contracts protecting your assets</p>
          </div>
          ...
          <div className="pixel-card p-6 bg-gray-800 border-2 border-green-400">
            ...
            <h3 className="text-xl font-bold mb-2 pixel-text">OPTIMAL YIELDS</h3>
            <p className="text-gray-300 pixel-text-sm">Auto-compound and rebalance for maximum returns</p>
          </div>
          ...
          <div className="pixel-card p-6 bg-gray-800 border-2 border-green-400">
            ...
            <p className="text-gray-300 pixel-text-sm">Access yields across multiple blockchains</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16 bg-gray-900">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="pixel-stat">
            ...
            <div className="text-gray-300 pixel-text-sm">TOTAL VALUE LOCKED</div>
          </div>
          <div className="pixel-stat">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 pixel-text">POWERED BY ARBITRUM</h2>
          <p className="text-gray-300 pixel-text-sm">Experience lightning-fast transactions with minimal fees</p>
        </div>
        ...
        <div className="network-grid">
          <div className="max-w-lg mx-auto">
            <div className="network-node arbitrum pixel-card p-8 bg-gray-800 border-2 border-green-400">
              ...
              <span className="network-label block text-xl mb-4">ARBITRUM NETWORK</span>
          ...
          <div className="network-info pixel-card p-6 bg-gray-800 border-2 border-green-400 mt-8 max-w-lg mx-auto">
            <div className="flex items-center justify-center gap-4 mb-4">
              ...
              <span className="text-xl font-bold pixel-text">SEAMLESS BRIDGING</span>
            </div>
            <p className="text-gray-300 pixel-text-sm text-center">
              Easily bridge your assets to Arbitrum and start earning optimal yields instantly
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 pixel-text">FREQUENTLY ASKED QUESTIONS</h2>
          <div className="flex items-center justify-center gap-2">
            <HelpCircle className="w-6 h-6 text-green-400" />
            <p className="text-gray-300 pixel-text-sm">Everything you need to know about Yieldex</p>
          </div>
        </div>

        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1" className="pixel-card bg-gray-800 border-2 border-green-400">
              <AccordionTrigger className="px-6 py-4 text-left hover:no-underline">
                <span className="text-lg font-bold pixel-text">What is Yieldex?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4">
                <p className="text-gray-300 pixel-text-sm">
                  Yieldex is a DeFi yield optimizer that automatically manages your stablecoin portfolio across multiple protocols and chains to maximize returns while minimizing risk and gas fees.
                </p>
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-2" className="pixel-card bg-gray-800 border-2 border-green-400">
              <AccordionTrigger className="px-6 py-4 text-left hover:no-underline">
                <span className="text-lg font-bold pixel-text">How does it work?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4">
                <p className="text-gray-300 pixel-text-sm">
                  Our smart contracts continuously monitor yield opportunities across major DeFi protocols. When better rates are available, your funds are automatically moved to capture the highest yields, all while maintaining your preferred risk parameters.
                </p>
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-3" className="pixel-card bg-gray-800 border-2 border-green-400">
              <AccordionTrigger className="px-6 py-4 text-left hover:no-underline">
                <span className="text-lg font-bold pixel-text">Is it safe?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4">
                <p className="text-gray-300 pixel-text-sm">
                  Security is our top priority. Our smart contracts are audited by leading firms, and we only integrate with battle-tested protocols. We also implement strict risk management strategies and maintain insurance coverage for additional protection.
                </p>
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-4" className="pixel-card bg-gray-800 border-2 border-green-400">
              <AccordionTrigger className="px-6 py-4 text-left hover:no-underline">
                <span className="text-lg font-bold pixel-text">What are the fees?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4">
                <p className="text-gray-300 pixel-text-sm">
            ...
            <AccordionItem value="item-5" className="pixel-card bg-gray-800 border-2 border-green-400">
              <AccordionTrigger className="px-6 py-4 text-left hover:no-underline">
                <span className="text-lg font-bold pixel-text">Which assets are supported?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4">
                <p className="text-gray-300 pixel-text-sm">
                  We currently support major stablecoins including USDC, USDT, and DAI across multiple chains. More assets and chains will be added based on community demand and security considerations.
                </p>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6 pixel-text">READY TO LEVEL UP YOUR YIELDS?</h2>
          <button className="pixel-button bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 flex items-center gap-2 mx-auto">
            <Coins className="w-5 h-5" />
            CONNECT WALLET
          </button>
        </div>
